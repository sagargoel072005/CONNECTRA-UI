          ...
          <div className="space-y-5">
              ...
              <>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="pl-10 w-full bg-white/10 text-white rounded-xl py-3 px-4"
                    value={firstName}
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-10 w-full bg-white/10 text-white rounded-xl py-3 px-4"
                value={password}
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-3 rounded-xl bg-white text-black font-medium hover:bg-gray-200 transition"
            >
              <FaGoogle />
            ...
            {/* SWITCH FORM */}
            <p
              className="text-center text-sm text-blue-400 cursor-pointer mt-4"
              onClick={() => {
